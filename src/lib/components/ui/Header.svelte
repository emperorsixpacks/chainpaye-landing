  ...
  <nav class="mx-auto px-2 py-4">
    <div class="flex items-center justify-between">
      ...
      <div class="hidden items-center space-x-4 md:flex">
        <a href="/for-businesses" class="text-gray-800 hover:text-gray-700"
          >For Businesses</a
        >
        <a href="/use-cases" class="text-gray-800 hover:text-gray-700"
          >Use cases</a
        >
  ...
  {#if isOpen}
    ...
    >
      ...
      <div class="mt-8 flex flex-col items-start space-y-6">
        <a href="/for-businesses" class="text-lg text-gray-200 hover:text-white"
          >For Businesses</a
        >
        <a href="/use-cases" class="text-lg text-gray-200 hover:text-white"
          >Use cases</a
        >
